...
void Spell::EffectTeleportUnits(SpellEffIndex /*effIndex*/)
{
	...
	if (mapid == unitTarget->GetMapId())
	{
		...
		{
			unitTarget->NearTeleportTo(x, y, z, orientation, unitTarget == m_caster, false, false, true);
...
void Spell::EffectOpenLock(SpellEffIndex effIndex)
{
    ...
    if (gameObjTarget)
    {
        ...
        if (m_spellInfo->Id == 1842 && gameObjTarget->GetGOInfo()->type == GAMEOBJECT_TYPE_TRAP)
        {
